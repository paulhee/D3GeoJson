...
var CQData_in = [
    [{name: '四川'}, {name: '重庆', value: 336371}],
    [{name: '贵州'}, {name: '重庆', value: 58766}],
    [{name: '湖北'}, {name: '重庆', value: 35465}],
    [{name: '湖南'}, {name: '重庆', value: 25481}],
    [{name: '云南'}, {name: '重庆', value: 20954}],
    [{name: '河南'}, {name: '重庆', value: 19363}],
    [{name: '广东'}, {name: '重庆', value: 15688}],
    [{name: '江西'}, {name: '重庆', value: 13565}],
    [{name: '浙江'}, {name: '重庆', value: 12930}],
    [{name: '福建'}, {name: '重庆', value: 12629}],
    [{name: '安徽'}, {name: '重庆', value: 11609}],
    [{name: '江苏'}, {name: '重庆', value: 10797}],
    [{name: '广西'}, {name: '重庆', value: 10458}],
    [{name: '陕西'}, {name: '重庆', value: 10060}],
    [{name: '河北'}, {name: '重庆', value: 9372}],
    [{name: '山东'}, {name: '重庆', value: 8696}],
    [{name: '甘肃'}, {name: '重庆', value: 6213}],
    [{name: '新疆'}, {name: '重庆', value: 4882}],
    [{name: '山西'}, {name: '重庆', value: 4545}],
    [{name: '黑龙江'}, {name: '重庆', value: 3813}],
    [{name: '辽宁'}, {name: '重庆', value: 3316}],
    [{name: '北京'}, {name: '重庆', value: 3068}],
    [{name: '吉林'}, {name: '重庆', value: 2763}],
    [{name: '内蒙古'}, {name: '重庆', value: 2174}],
    [{name: '上海'}, {name: '重庆', value: 1967}],
    [{name: '海南'}, {name: '重庆', value: 1563}],
    [{name: '天津'}, {name: '重庆', value: 1430}],
    [{name: '西藏'}, {name: '重庆', value: 1356}],
    [{name: '青海'}, {name: '重庆', value: 1183}],
    [{name: '宁夏'}, {name: '重庆', value: 737}],
    [{name: '台湾'}, {name: '重庆', value: 151}],
    [{name: '香港'}, {name: '重庆', value: 122}],
    [{name: '澳门'}, {name: '重庆', value: 10}],
    [{name: '重庆'}, {name: '重庆', value: 0}]
];
...
var CQData_in_sc = [
    [{name: '广安'}, {name: '重庆', value: 80123}],
    [{name: '达州'}, {name: '重庆', value: 36764}],
    [{name: '南充'}, {name: '重庆', value: 29045}],
    [{name: '资阳'}, {name: '重庆', value: 25502}],
    [{name: '成都'}, {name: '重庆', value: 21366}],
    [{name: '泸州'}, {name: '重庆', value: 19818}],
    [{name: '内江'}, {name: '重庆', value: 19420}],
    [{name: '遂宁'}, {name: '重庆', value: 18109}],
    [{name: '宜宾'}, {name: '重庆', value: 13227}],
    [{name: '自贡'}, {name: '重庆', value: 10912}],
    [{name: '巴中'}, {name: '重庆', value: 9718}],
    [{name: '绵阳'}, {name: '重庆', value: 8022}],
    [{name: '广元'}, {name: '重庆', value: 6535}],
    [{name: '乐山'}, {name: '重庆', value: 5472}],
    [{name: '德阳'}, {name: '重庆', value: 5264}],
    [{name: '眉山'}, {name: '重庆', value: 4882}],
    [{name: '凉山'}, {name: '重庆', value: 4073}],
    [{name: '攀枝花'}, {name: '重庆', value: 2653}],
    [{name: '雅安'}, {name: '重庆', value: 1910}],
    [{name: '阿坝'}, {name: '重庆', value: 813}],
    [{name: '甘孜'}, {name: '重庆', value: 434}],
    [{name: '重庆'}, {name: '重庆', value: 0}]
];
var overlay;
function leafletecharts_population() {
    map.setView([34.281673,108.952214],5);
    //leaflet上使用echarts
    ...
    var series = [];
    [['全国流入重庆', CQData_in], ['四川流入重庆', CQData_in_sc]].forEach(function (item, i) {
        series.push(
            // {
            //     name: item[0] + ' Top10',
            //     type: 'lines',
            ...
            },
            {
                ...
                data: item[1].map(function (dataItem) {
                    return {
                        ...
                        lonlat:geoCoordMap[dataItem[0].name]//自定义，主要用于地图拖动、缩放时的计算
                    };
                })
            });
    });
...
function nanocube() {
    ...
    document.getElementById("container_echarts").appendChild(iframe);
}